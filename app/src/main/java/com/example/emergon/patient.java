...
import com.example.emergon.databinding.ActivityPatientBinding;
...
//        });
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow, R.id.nav_gene,R.id.nav_vpress,R.id.nav_map,R.id.nav_pulse,R.id.nav_reminder,R.id.nav_medical)
