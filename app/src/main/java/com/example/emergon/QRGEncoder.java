...
public class QRGEncoder {
    ...
    public QRGEncoder(String data, String type) {
        encoded = encodeContents(data, null, com.example.emergon.QRGContents.Type.TEXT);
    }
    ...
    private void encodeQRCodeContents(String data, Bundle bundle, String type) {
        switch (type) {
            case com.example.emergon.QRGContents.Type.TEXT:
                ...
                break;
            case com.example.emergon.QRGContents.Type.EMAIL:
                data = trim(data);
                if (data != null) {
                ...
                break;
            case com.example.emergon.QRGContents.Type.PHONE:
                data = trim(data);
                if (data != null) {
                    contents = "tel:" + data;
                ...
                break;
            case com.example.emergon.QRGContents.Type.SMS:
                data = trim(data);
                if (data != null) {
                    contents = "sms:" + data;
                    displayContents = PhoneNumberUtils.formatNumber(data);
                ...
                break;
            case com.example.emergon.QRGContents.Type.CONTACT:
                if (bundle != null) {
                    ...
                    Collection<String> uniquePhones = new HashSet<>(com.example.emergon.QRGContents.PHONE_KEYS.length);
                    for (int x = 0; x < com.example.emergon.QRGContents.PHONE_KEYS.length; x++) {
                        String phone = trim(bundle.getString(com.example.emergon.QRGContents.PHONE_KEYS[x]));
                        if (phone != null) {
                    ...
                    Collection<String> uniqueEmails = new HashSet<>(com.example.emergon.QRGContents.EMAIL_KEYS.length);
                    for (int x = 0; x < com.example.emergon.QRGContents.EMAIL_KEYS.length; x++) {
                        String email = trim(bundle.getString(com.example.emergon.QRGContents.EMAIL_KEYS[x]));
                        if (email != null) {
                ...
                break;
            case com.example.emergon.QRGContents.Type.LOCATION:
                if (bundle != null) {
