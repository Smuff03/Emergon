...
public class QRGSaver {
    ...
    public boolean save(String saveLocation, String imageName, Bitmap bitmap) {
        return save(saveLocation, imageName, bitmap, com.example.emergon.QRGContents.ImageType.IMAGE_PNG);
    }

    private String imgFormat(int imageFormat) {
        return imageFormat == com.example.emergon.QRGContents.ImageType.IMAGE_PNG ? ".png" : ".jpg";
    }

    private Comparable<? extends Comparable<? extends Comparable<?>>> compressFormat(int imageFormat) {
        return imageFormat == com.example.emergon.QRGContents.ImageType.IMAGE_PNG ? Bitmap.CompressFormat.PNG :
                (imageFormat == com.example.emergon.QRGContents.ImageType.IMAGE_WEBP ? Bitmap.CompressFormat.WEBP : Bitmap.CompressFormat.JPEG);
    }
